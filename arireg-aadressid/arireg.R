...
arireg <- fread("ettevotja_rekvisiidid_2018-11-21.csv", encoding = "UTF-8")
arireg <- arireg %>% 
...
volg <- read_excel("maksuvolglaste_nimekiri.xlsx", skip = 2)
...
ehitis <- fread("eh_ehitised_1994-01_2018-11-24.csv", encoding = "UTF-8") %>% filter(rajatis_hoone == "H") %>% 
