...
kontakt <- read_xlsx("C:/Users/annegrete.peek/Dropbox/Sparkline/Avaandmed/Koolid/alus_yld_oppeasutused_oppurid.xlsx", sheet ="kontakt", skip = 6)
andmed13 <- read_xlsx("C:/Users/annegrete.peek/Dropbox/Sparkline/Avaandmed/Koolid/alus_yld_oppeasutused_oppurid.xlsx", sheet ="2013", skip = 9) %>% mutate(Aasta = 2013) %>% 
...
andmed14 <- read_xlsx("C:/Users/annegrete.peek/Dropbox/Sparkline/Avaandmed/Koolid/alus_yld_oppeasutused_oppurid.xlsx", sheet ="2014", skip = 9) %>% mutate(Aasta = 2014) %>% 
...
andmed15 <- read_xlsx("C:/Users/annegrete.peek/Dropbox/Sparkline/Avaandmed/Koolid/alus_yld_oppeasutused_oppurid.xlsx", sheet ="2015", skip = 9) %>% mutate(Aasta = 2015) %>% 
...
andmed16 <- read_xlsx("C:/Users/annegrete.peek/Dropbox/Sparkline/Avaandmed/Koolid/alus_yld_oppeasutused_oppurid.xlsx", sheet ="2016", skip = 9) %>% mutate(Aasta = 2016) %>% 
...
andmed17 <- read_xlsx("C:/Users/annegrete.peek/Dropbox/Sparkline/Avaandmed/Koolid/alus_yld_oppeasutused_oppurid.xlsx", sheet ="2017", skip = 9) %>% mutate(Aasta = 2017) %>% 
